...
export default {
  ...
  methods: {
    render() {
      ...
      var color_plane = new THREE.Color("rgb(8, 7, 8)");
      //var color_separe = new THREE.Color("rgb(17, 17, 17)");
      var color_separe = new THREE.Color("rgb(0, 166, 251)");
      //var color_borderPlane = new THREE.Color("rgb(0, 34, 35)");
      var color_borderPlane = new THREE.Color("rgb(55, 0, 140)");
      ...
      function init() {
        ...
        for (let i = -1; i < 2; i++) {
          for (let j = -1; j < 2; j++) {
            ...
            const object = new THREE.Mesh(geometryCube, materialPlane);
            k += 1;
            object.position.x = j;
            object.position.y = 0;
            object.position.z = i;
        ...
        folder
          ...
          .name("Separe")
          .onChange(function () {
            materialSepare.color.set(params.modelcolor);
          });
        folder
          .addColor(params, "modelcolor")
          .name("Plane")
          .onChange(function () {
            materialPlane.color.set(params.modelcolor);
          });
        folder
          .addColor(params, "modelcolor")
          .name("External Plane")
          .onChange(function () {
            materialBorderPlane.color.set(params.modelcolor);
          });
        folder.open();*/
